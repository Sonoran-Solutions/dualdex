...
object HnsCalcCensusBaseline {
    ...
    /**
     * The pinned upstream engine identity `capabilityFor` recognizes.
     *
     * `POKEMON_HNS` makes `include/constants/global.h` define `IS_HNS 1`, so `src/data.c` compiles
     * the H&S trainer table `data/trainers_hns.h` -- generated by `tools/trainerproc` from
     * `src/data/trainers_hns.party`, which is the committed source this census reads.
     */
