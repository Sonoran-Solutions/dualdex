 ...
 * Generated by tools/hns-data-pack/generate_hns_data_pack.py
 *
 * Provenance:
 *   Repository: PokemonHnS-Development/pokehns-expansion
 *   Tag: Release-v2.0.5
 *   Commit: 1f42b74dff0e9fe942419845d040663dd829a973
 *   Authoritative Species Count: 1427
 *   Authoritative Moves Count: 934
 */
object HeartAndSoul205DataPack : GameDataPack {
    ...
    override fun getMove(id: Int): MoveInfo? = moveMap[id]
    ...
    override fun isMoveAuthoritative(id: Int): Boolean = moveMap.containsKey(id)
    ...
    private fun registerMove(id: Int, name: String, type: PokemonType, category: MoveCategory, power: Int, acc: Int, pp: Int) {
        moveMap[id] = MoveInfo(id, name, type, category, power, acc, pp)
    }
    ...
    private fun registerMoveChunk5() {
        ...
        registerMove(867, "10,000,000 Volt Thunderbo", PokemonType.ELECTRIC, MoveCategory.SPECIAL, 195, 0, 1)
        ...
        registerMove(880, "Menacing Moonraze Maelstr", PokemonType.GHOST, MoveCategory.SPECIAL, 200, 0, 1)
        registerMove(881, "Light That Burns The Sky", PokemonType.PSYCHIC, MoveCategory.SPECIAL, 200, 0, 1)
        registerMove(882, "Soul-Stealing 7-Star Stri", PokemonType.GHOST, MoveCategory.PHYSICAL, 195, 0, 1)
    ...
    private fun registerMoveChunk6() {
